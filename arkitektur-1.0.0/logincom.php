...
session_start();
 ...
 if ($_SERVER["REQUEST_METHOD"]== "POST") {
    $name = $_POST['name'];
    $password = $_POST['pass'];
	$sql = "SELECT * FROM company WHERE cname = '$name' AND ccpass = '$password'";
	...
	exit();  } else {
         echo "Incorrect password or invalid user.";
        }
 }
     $conn->close();
		...
		<div class="container">
			...
			<div class="row justify-content-center">
				<div class="col-md-6 col-lg-4">
		      	...
		      	<h3 class="mb-4 text-center">Don't have an account?<a href="registercom.php"> Register now!</a></h3>
