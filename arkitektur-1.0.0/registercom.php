...
$cpassword = $_POST['cpass'];
        ...
        $sql = "INSERT INTO company(cname, cemail , cproof, ccpass)  VALUES ('$name','$email','$file','$password')";
		...
		<div class="container">
			...
			<div class="row justify-content-center">
				<div class="col-md-6 col-lg-4">
		      	...
		      	<h3 class="mb-4 text-center">Have an account?<a href="logincom.php"><br>Login now!</a></h3>
		      	...
		      	<form action="<?php $_SERVER['PHP_SELF']; ?>" method="POST" class="signin-form">
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" name="file" class="form-control" placeholder="Brand License" required>
                    </div>
